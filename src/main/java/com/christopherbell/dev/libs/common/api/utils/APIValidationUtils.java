...
public final class APIValidationUtils {
   ...
   */
  public static boolean isValidClientId(List<String> acceptedClients, String requestClientId) throws InvalidRequestException {
  ...
  /**
   * Checks to see if some string is blank, empty, or null. If it is, then throw an InvalidRequestException.
   * The idea is to use this on required fields.
   ...
   */
  public static boolean isValidResource(String errorMessage, String questionableResource) throws InvalidRequestException {
